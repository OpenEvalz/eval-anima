...
**Paper:** https://arxiv.org/abs/2604.13076

Evaluates the quality of a model's moral reasoning about animal welfare across 13 ethical
dimensions.
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/anima`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/anima) |
| Group | Safeguards |
| Total samples | 26 |
...
- `huggingface` — `CompassioninMachineLearning/anima` (pinned)
